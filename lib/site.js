...
// The engine under the hood. Star count is the upstream project's, rounded —
// it is not fetched, so nudge it when yt-dlp crosses the next round number.
export const YT_DLP_URL = 'https://github.com/yt-dlp/';
export const YT_DLP_STARS = '236k';
...
// (same idea as YT_DLP_STARS) rather than anything live — nudge them.
