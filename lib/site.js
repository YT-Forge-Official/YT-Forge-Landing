...
export const PLATFORMS = [
  ...
  },
  {
    id: 'linux',
    name: 'Linux',
    tagline: 'AppImage & .deb',
    note: 'x64 and ARM devices',
    ext: '.AppImage',
    builds: [
      { label: 'x64 (AppImage)', href: dl(`YT-Forge-${VERSION}.AppImage`), primary: true },
      { label: 'x64 (.deb)', href: dl(`yt-forge_${VERSION}_amd64.deb`) },
      { label: 'arm64 (AppImage)', href: dl(`YT-Forge-${VERSION}-arm64.AppImage`) },
      { label: 'arm64 (.deb)', href: dl(`yt-forge_${VERSION}_arm64.deb`) },
    ],
  },
];
