...
/* ============================================================
   Brand marks — verbatim from simple-icons (CC0). Reproduced as
   published rather than redrawn, so the geometry is the real one.
   ============================================================ */

export function YouTubeMark({ className = 'size-4' }) {
  return (
...
export function LinkedInMark({ className = 'size-4' }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden>
...
export function InstagramMark({ className = 'size-4' }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden>
